...
# FAM Database Startup Script
# This script starts only the PostgreSQL database service
...
print_header "Starting FAM Database"
...
print_info "- Database: fam_db"
print_info "- User: fam_user"